...
// ----------------------------------------------------------------------------
// system calls - dirty hacks for coccinelle
// - fake a first parameter that can be matched from a rule
// - must have the name of the macro, so that it won't be filtered out with --dir
// ----------------------------------------------------------------------------

#define SYSCALL_DEFINE0(func) \
    unsigned long func(void SYSCALL_DEFINE0, void)
#define SYSCALL_DEFINE1(func, t1, a1) \
    unsigned long func(void SYSCALL_DEFINE1, t1 a1)
#define SYSCALL_DEFINE2(func, t1, a1, t2, a2) \
    unsigned long func(void SYSCALL_DEFINE2, t1 a1, t2 a2)
#define SYSCALL_DEFINE3(func, t1, a1, t2, a2, t3, a3) \
    unsigned long func(void SYSCALL_DEFINE3, t1 a1, t2 a2, t3 a3)
#define SYSCALL_DEFINE4(func, t1, a1, t2, a2, t3, a3, t4, a4) \
    unsigned long func(void SYSCALL_DEFINE4, t1 a1, t2 a2, t3 a3, t4 a4)
#define SYSCALL_DEFINE5(func, t1, a1, t2, a2, t3, a3, t4, a4, t5, a5) \
    unsigned long func(void SYSCALL_DEFINE5, t1 a1, t2 a2, t3 a3, t4 a4, t5 a5)
#define SYSCALL_DEFINE6(func, t1, a1, t2, a2, t3, a3, t4, a4, t5, a5, t6, a6) \
    unsigned long func(void SYSCALL_DEFINE6, t1 a1, t2 a2, t3 a3, t4 a4, t5 a5, t6 a6)

#define COMPAT_SYSCALL_DEFINE0(func) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE0)
#define COMPAT_SYSCALL_DEFINE1(func, t1, a1) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE1, t1 a1)
#define COMPAT_SYSCALL_DEFINE2(func, t1, a1, t2, a2) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE2, t1 a1, t2 a2)
#define COMPAT_SYSCALL_DEFINE3(func, t1, a1, t2, a2, t3, a3) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE3, t1 a1, t2 a2, t3 a3)
#define COMPAT_SYSCALL_DEFINE4(func, t1, a1, t2, a2, t3, a3, t4, a4) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE4, t1 a1, t2 a2, t3 a3, t4 a4)
#define COMPAT_SYSCALL_DEFINE5(func, t1, a1, t2, a2, t3, a3, t4, a4, t5, a5) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE5, t1 a1, t2 a2, t3 a3, t4 a4, t5 a5)
#define COMPAT_SYSCALL_DEFINE6(func, t1, a1, t2, a2, t3, a3, t4, a4, t5, a5, t6, a6) \
    unsigned long func(void COMPAT_SYSCALL_DEFINE6, t1 a1, t2 a2, t3 a3, t4 a4, t5 a5, t6 a6)
